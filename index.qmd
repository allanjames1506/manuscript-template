...
::: {#fig-method-diagram layout-nrow="2"}
::: {#fig-method-a}
```{mermaid}
%%| fig-alt: Plots of the averaged z-score cluster profiles for DE genes and DTU transcripts
...
::: {#fig-zscore-clusters layout-ncol="2"}
![DE gene clusters](03_plots/copilot/plot_DE.png){#fig-clusters-a}

![DTU transcript clusters](03_plots/copilot/plot_DTU.png){#fig-clusters-b}
...
```{r}
#| label: tab-overlap-clusters_ChIP
#| tab-cap: Overlap of ChIP targets with DE gene- and DTU transcript-clusters
#| tab-alt: A summary table describing overlap between ChIP study targets with cluster genes and transcripts.
...
::: {#fig-amp-rhy-scatter layout="[65, 35]"}
![DE and DTU cluster amplitudes and rhythm scatter plots](03_plots/copilot/rhythm_amp_facets_DE_DTU.png){#fig-scatter-a}

::: {#fig-right-column layout-nrow="2"}
![Caption for Panel B](03_plots/copilot/amp_summary_plot.png){#fig-scatter-b} ![Caption for Panel C](03_plots/copilot/rhy_summary_plot.png){#fig-scatter-c}
:::

DE and DTU cluster amplitudes and rhythms across cooling.
:::

```{r}
#| label: fig-bar-plot-merge
#| fig-cap: Clock ChIP target overlap with DE and DTU cluster constituents 
#| fig-alt: Bar plots showing percent overlap of clock ChIP targets with the DE and DTU cluster memberships
#| out-width : "95%"
