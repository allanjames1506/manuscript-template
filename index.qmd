...
clusters_plot_DE <- clusters_aggregated_DE_pivot_longer %>%
  ...
  theme(strip.text = element_text(face = "bold", color = "grey20", hjust = 0.5, size = 8),
...
clusters_plot_DE <- clusters_plot_DE + 
  ...
  theme(plot.title = element_text(size=12, color='black', face='bold', hjust =0))
...
# clusters_plot_DE + (clusters_plot_DTU /calixto_S7B_summary_plot + plot_layout(heights = c(5.5,1))) +
#   plot_annotation(tag_levels = 'A') &
#   theme(plot.tag = element_text(size = 12, face = 'bold')) &
#   theme(plot.background = element_rect(fill = "white", colour = "white"))

clusters_plot_DE + clusters_plot_DTU +
  plot_annotation(tag_levels = 'A') &
  theme(plot.tag = element_text(size = 12, face = 'bold')) &
  theme(plot.background = element_rect(fill = "white", colour = "white"))

# clusters_plot_DE / clusters_plot_DTU /calixto_S7B_summary_plot + plot_layout(heights = c(5, 4, 1)) +
#   plot_annotation(tag_levels = 'A') &
#   theme(plot.tag = element_text(size = 12, face = 'bold')) &
#   theme(plot.background = element_rect(fill = "white", colour = "white"))
